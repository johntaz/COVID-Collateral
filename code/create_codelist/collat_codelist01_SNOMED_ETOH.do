...
DO FILE NAME:	collat_codelist01_SNOMED_ETOH

AUTHOR:			Kate Mansfield	
VERSION:		v1 (originally called something different)
...
DATASETS USED: 	Aurum medical code browser: ${pathBrowsersAurum}/CPRDAurumMedical.dta
				...
				readcodes-AUDIT.dta // codes from AUDIT project 	
									// BMJ Open paper
									// 1. Mansfield K, Crellin E, Denholm R, Quint 
...
global filename "collat_codelist01_SNOMED_ETOH"
...
#4. Cross check with other files
		- Perhaps work back from Read code lists using cleansedreadcode var
*******************************************************************************/
* N/A
...
/*******************************************************************************
#5. Tidy up and save working codelist
*******************************************************************************/
...
/*******************************************************************************
#6. Review codelists from AUDIT project
*******************************************************************************/
/*------------------------------------------------------------------------------
#6.1 load dataset and merge with SNOMED codes
------------------------------------------------------------------------------*/
