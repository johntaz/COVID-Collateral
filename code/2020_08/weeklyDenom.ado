...
*qui
merge 1:1 patid using "$diabDataDir\diabetesType.dta", keep(match) nogen keepusing(patid) // update to include type
}
...
*qui 
merge 1:1 patid using "$diabDataDir\diabetesType.dta", keep(match) nogen
